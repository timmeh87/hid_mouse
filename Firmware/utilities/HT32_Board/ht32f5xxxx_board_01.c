...
/** @defgroup HT32F5xxxx_BOARD_Global_Variable HT32F5xxxx Board global variables
  ...
  */
  ...
  const u8 BUTTON_GPIO_ID[BUTTONn] = {
	WAKEUP_BUTTON_GPIO_ID, KEY1_BUTTON_GPIO_ID, KEY2_BUTTON_GPIO_ID, KEY3_BUTTON_GPIO_ID, KEY4_BUTTON_GPIO_ID,
	KEY5_BUTTON_GPIO_ID, KEY6_BUTTON_GPIO_ID, KEY7_BUTTON_GPIO_ID, KEY8_BUTTON_GPIO_ID, KEY9_BUTTON_GPIO_ID};
  
  const u16 BUTTON_GPIO_PIN[BUTTONn] = {
	 WAKEUP_BUTTON_GPIO_PIN, KEY1_BUTTON_GPIO_PIN, KEY2_BUTTON_GPIO_PIN, KEY3_BUTTON_GPIO_PIN, KEY4_BUTTON_GPIO_PIN, 
	 KEY5_BUTTON_GPIO_PIN, KEY6_BUTTON_GPIO_PIN, KEY7_BUTTON_GPIO_PIN, KEY8_BUTTON_GPIO_PIN, KEY9_BUTTON_GPIO_PIN};
  ...
  const AFIO_MODE_Enum BUTTON_AFIO_MODE[BUTTONn] = {
	...
	KEY5_BUTTON_AFIO_MODE, KEY6_BUTTON_AFIO_MODE, KEY7_BUTTON_AFIO_MODE, KEY8_BUTTON_AFIO_MODE, KEY9_BUTTON_AFIO_MODE
  };
  ...
  const u8 BUTTON_EXTI_CH[BUTTONn] = {
    WAKEUP_BUTTON_EXTI_CHANNEL, KEY1_BUTTON_EXTI_CHANNEL, KEY2_BUTTON_EXTI_CHANNEL, KEY3_BUTTON_EXTI_CHANNEL, KEY4_BUTTON_EXTI_CHANNEL, 
	  KEY5_BUTTON_EXTI_CHANNEL, KEY6_BUTTON_EXTI_CHANNEL, KEY7_BUTTON_EXTI_CHANNEL, KEY8_BUTTON_EXTI_CHANNEL, KEY9_BUTTON_EXTI_CHANNEL
  };
...
void HT32F_DVB_PBInit(BUTTON_TypeDef BUTTON_x, BUTTON_MODE_TypeDef BUTTON_MODE_x)
{
  ...
  if (BUTTON_MODE_x == BUTTON_MODE_EXTI)
  {
    ...
    */
    ...
    EXTI_InitStruct.EXTI_IntType = EXTI_BOTH_EDGE; //tim changed default to both edges
	if (BUTTON_x == BUTTON_WAKEUP) { EXTI_InitStruct.EXTI_IntType =  EXTI_POSITIVE_EDGE;}
