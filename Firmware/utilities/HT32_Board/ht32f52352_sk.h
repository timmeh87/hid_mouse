...
//idk this was already in the demo... maybe remove?
...
//dpi (bottom)
#define KEY3_BUTTON_GPIO_ID         (GPIO_PC)
#define KEY3_BUTTON_GPIO_PIN        (GPIO_PIN_4)
#define KEY3_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY3_BUTTON_EXTI_CHANNEL    (4)

//wheel click
#define KEY4_BUTTON_GPIO_ID         (GPIO_PB)
#define KEY4_BUTTON_GPIO_PIN        (GPIO_PIN_3)
#define KEY4_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY4_BUTTON_EXTI_CHANNEL    (3)

//middle click  (not wheel)
#define KEY5_BUTTON_GPIO_ID         (GPIO_PB)
#define KEY5_BUTTON_GPIO_PIN        (GPIO_PIN_2)
#define KEY5_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY5_BUTTON_EXTI_CHANNEL    (2)

//encoder A
#define KEY6_BUTTON_GPIO_ID         (GPIO_PA)
#define KEY6_BUTTON_GPIO_PIN        (GPIO_PIN_14)
#define KEY6_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY6_BUTTON_EXTI_CHANNEL    (14)
#define KEY6_HT_GPIO				HT_GPIOA

//encoder B
#define KEY7_BUTTON_GPIO_ID         (GPIO_PA)
#define KEY7_BUTTON_GPIO_PIN        (GPIO_PIN_15)
#define KEY7_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY7_BUTTON_EXTI_CHANNEL    (15)
#define KEY7_HT_GPIO				HT_GPIOA

//side button 1
#define KEY8_BUTTON_GPIO_ID         (GPIO_PA)
#define KEY8_BUTTON_GPIO_PIN        (GPIO_PIN_10)
#define KEY8_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY8_BUTTON_EXTI_CHANNEL    (10)

//side button 2
#define KEY9_BUTTON_GPIO_ID         (GPIO_PA)
#define KEY9_BUTTON_GPIO_PIN        (GPIO_PIN_8)
#define KEY9_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY9_BUTTON_EXTI_CHANNEL    (8)

//YOU CANT JUST DEFINE THEM HERE YOU ALSO HAVE TO ADD THESE DEFINES TO BOARD C FILE ARRAYS
